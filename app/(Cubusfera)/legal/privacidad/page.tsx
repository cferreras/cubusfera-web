        ...
        <>
            <Container className="py-20">
                ...
                <div className="dark:text-gray-300 text-gray-800">
                    ...
                    <h2 className="text-md font-semibold  mb-2">Recopilación de su Información</h2>
                    ...
                    <h2 className="text-md font-semibold mt-8 mb-2">Cookies y Almacenamiento</h2>
                    ...
                    <h2 className="text-md font-semibold mt-8 mb-2">Retención de Datos</h2>
                    ...
                    <h2 className="text-md font-semibold mt-8 mb-2">Compartir Información con Terceros</h2>
                    <p className="mb-2">No vendemos, alquilamos ni arrendamos ninguna información del usuario a terceros.</p>

                    <h2 className="text-md font-semibold mt-8 mb-2">Utilizamos:</h2>
                    <ul>
                    ...
                    <h2 className="text-md font-semibold mt-8 mb-2">Seguridad de su Información</h2>
                    ...
                    <h2 className="text-md font-semibold mt-8 mb-2">Menores de Edad</h2>
                    ...
                    <h2 className="text-md font-semibold mt-8 mb-2">Cambios en esta Política</h2>
                    ...
                    <h2 className="text-md font-semibold mt-8 mb-2">Información de Contacto</h2>
