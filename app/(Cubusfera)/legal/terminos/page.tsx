        ...
        <>
            <Container className="py-20">
                ...
                <div className="text-gray-300">
                    ...
                    <h2 className="text-md font-semibold text-white mt-8 mb-2">Inicio de Sesión y Autenticación</h2>
                    ...
                    <h2 className="text-md font-semibold text-white mt-8 mb-2">Limitación de Responsabilidad</h2>
                    ...
                    <h2 className="text-md font-semibold text-white mt-8 mb-2">Cambios en los Términos</h2>
                    ...
                    <h2 className="text-md font-semibold text-white mt-8 mb-2">Contacto</h2>
