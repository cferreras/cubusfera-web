...
export default function TheHeader() {
    ...
    return (
        <header className="relative max-w-7xl mx-auto py-32 md:py-48 text-center px-6">
            <motion.div 
            ...
            <div className="relative flex flex-col items-center">
                <motion.h1 
                    className="text-6xl sm:text-7xl 2xl:text-8xl text-center font-bold"
                    initial={{ opacity: 0 }}
                    animate={{ opacity: 1 }}
                ...
                >
                    ...
                    <a 
                        href="https://discord.gg/7uKEYACErc" 
                        className="px-6 py-3 bg-white/80 dark:bg-neutral-800/50 border border-neutral-200 dark:border-neutral-700 rounded-full font-medium transition-colors hover:bg-neutral-100 dark:hover:bg-neutral-700/70"
                    >
                        Discord
                    </a>
                </motion.div>
