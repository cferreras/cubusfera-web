        ...
        <nav className="bg-white shadow-lg">
            ...
            --> */}
                        ...
                        <div className="hidden lg:ml-6 lg:flex ">
                            ...
                            <Link href="/tienda" className="inline-flex items-center px-8 pt-1 text-sm text-gray-700 hover:bg-gray-100 transition-colors"><svg className='h-6 w-6 mr-2 text-indigo-600' xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24"><path fill="currentColor" d="M17 18c-1.1 0-1.99.9-1.99 2s.89 2 1.99 2s2-.9 2-2s-.9-2-2-2M7 18c-1.1 0-1.99.9-1.99 2S5.9 22 7 22s2-.9 2-2s-.9-2-2-2m0-3l1.1-2h7.45c.75 0 1.41-.41 1.75-1.03L21.7 4H5.21l-.94-2H1v2h2l3.6 7.59L3.62 17H19v-2z" /></svg> Tienda</Link>
            ...
            <div className={isOpen ? "block lg:hidden" : "hidden lg:hidden"} id="mobile-menu">
                    ...
                    <Link onClick={() => setIsOpen(!isOpen)} href="/tienda" className="flex hover:bg-gray-100 border-transparent py-4 pl-3 pr-4 text-base text-gray-700  hover:border-gray-300 sm:pl-5 sm:pr-6"><svg className='h-6 w-6 mr-2 text-indigo-600' xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24"><path fill="currentColor" d="M17 18c-1.1 0-1.99.9-1.99 2s.89 2 1.99 2s2-.9 2-2s-.9-2-2-2M7 18c-1.1 0-1.99.9-1.99 2S5.9 22 7 22s2-.9 2-2s-.9-2-2-2m0-3l1.1-2h7.45c.75 0 1.41-.41 1.75-1.03L21.7 4H5.21l-.94-2H1v2h2l3.6 7.59L3.62 17H19v-2z" /></svg> Tienda</Link>
